...
type Control = {enabled:boolean;settings:Config;callsLastHour:number;backgroundCallsLastHour:number;failuresLastHour:number;tokensLastHour:number;usageKnownCalls:number;backgroundFailuresLastHour:number;backgroundTokensLastHour:number;backgroundStages:Stage[]};
const stageNames:Record<string,string>={profile:'人物资料编译',understand:'理解',decide:'决策',express:'表达',reflect:'反思',research:'资料调查','skill-trial':'技能验证','method-review':'方法复核'};
