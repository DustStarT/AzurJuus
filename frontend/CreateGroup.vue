...
<template>
<button class="text-button" @click="open=true" aria-label="新建群聊">＋ 新建群聊</button>
...
<style scoped>.group-create{width:min(440px,90vw);max-height:80vh;overflow:auto;padding:24px;background:#f4fafc;border-radius:12px}.group-create header{display:flex;justify-content:space-between;align-items:center}fieldset{border:0;padding:16px 0;display:grid;grid-template-columns:1fr 1fr;gap:12px}label{display:flex;gap:8px;align-items:center}input[type=checkbox]{width:auto}</style>
