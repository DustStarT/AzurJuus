...
def install(app, service, coordinator):
    from backend.characters.relationship_research import install as install_research
    install_research(app,coordinator,service)
    from backend.chat.attachments import install as install_attachments
    ...
    def create_character(payload:NewCharacter):
        from backend.characters.terminal_characters import card,TERMINAL
        from backend.social.social_roster import enable_character
