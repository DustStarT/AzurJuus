...
from backend.social.idle_social import _generate
from backend.characters.character_identity import source_names,source_aliases,roster_actors
    ...
    async def tick(self):
        ...
        try:
            async def work():
                ...
                from backend.characters.terminal_characters import worldbook
