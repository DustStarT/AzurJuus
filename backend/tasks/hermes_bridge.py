...
class HermesBridge:
    ...
    async def start(self):
        ...
        config = {
            ...
            "mcp_servers": {"azurjuus": {"command": worker_python(), "args": ["-X", "utf8", str(ROOT / "backend" / "tasks" / "mcp_host.py")], "env": {"AZURJUUS_TOOL_ENDPOINT": "${AZURJUUS_TOOL_ENDPOINT}", "AZURJUUS_TOOL_TOKEN": "${AZURJUUS_TOOL_TOKEN}", "AZURJUUS_TOOL_ACTIONS": "${AZURJUUS_TOOL_ACTIONS}"}, "timeout": 3600}},
